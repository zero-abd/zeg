...
AFFIRMATIVE: Sequence[Answer] = (
    ...
    Answer("no, that's fine", True, "starts with 'no' and means yes"),
    Answer("I don't have a problem with that", True, "contains 'don't' and means yes"),
    Answer("all good", True),
    Answer("I'm good with that", True),
    Answer("you can record", True),
    Answer("you may record it", True),
    Answer("feel free", True),
    Answer("no, no, that's fine", True, "a stutter, and it means yes"),
    Answer("no no worries, go ahead", True, "a stutter before an agreement idiom"),
    Answer("I don't have problem with that", True, "an article a recogniser dropped"),
...
REFUSAL: Sequence[Answer] = (
    ...
    Answer("no, that's not fine", False, "the negation of 'no, that's fine'"),
    Answer("no, no, I'd rather not", False, "the same stutter, and it means no"),
    Answer("no no no", False),
    Answer("no, it's fine not to record", False, "'no, it's fine' refusing the recording"),
    Answer("feel free to not record me", False),
    Answer("you may not record", False),
    Answer("you can't record this", False),
    Answer("I'm not good with that", False),
    Answer("I do have a problem with that", False),
    Answer("all good, but please don't record", False),
    Answer("nope", False),
